...
(function(){
  ...
  const DATA={
    profile:{k:'プロフィール',t:'占い師が頼る、占い師。',html:`
      <p>有名占いサイトの<strong>専属占い師</strong>として活躍。口コミで評判が広がり、やがて<strong>同業の占い師からも相談が集まる</strong>存在に。現在は5つの占いサイトの運営・プロデュースも手がけています。</p>
      <p>相談実績は<strong>20,000人以上</strong>、育成した占い師は<strong>700名以上</strong>。恋する女性の本音を読み解いてきた、場数が違います。</p>
